...
table th,td{
    ...
    <body>
        ...
        <sql:setDataSource var="db" driver="com.mysql.jdbc.Driver" url="jdbc:mysql://lcpbq9az4jklobvq.cbetxkdyhwsb.us-east-1.rds.amazonaws.com/ehjn4n6t5lh0zafz" user="vt6q8mzm255je024" password="xgabcm5xp3gan7n0"/>
